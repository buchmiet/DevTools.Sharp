...
{
    /// <summary>
    /// Environment variable set by <c>DevKit.Logging.Runner</c> when the app is spawned with a detached console.
    /// </summary>
    public const string RemoteAttachVariable = "DEVKIT_LOGGING_ATTACH";

    /// <summary>
    /// Parses <c>--devkit-logging console|file &lt;path&gt;</c>, removes those tokens from <paramref name="args"/>,
    ...
    /// <summary>
    /// Attaches to a startup console owned by another process (typically <c>DevKit.Logging.Runner</c>).
    /// </summary>
