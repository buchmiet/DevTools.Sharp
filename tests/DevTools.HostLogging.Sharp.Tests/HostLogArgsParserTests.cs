...
namespace DevTools.HostLogging.Sharp.Tests;
...
public class HostLogArgsParserTests
{
    ...
    {
        var args = new[] { "import", "--devtools-hostlog", "console", "--path", "C:\\data" };
    ...
    {
        var args = new[] { "--devtools-hostlog", "file", "boot.log", "run" };
    ...
    {
        var args = new[] { "left", "--devtools-hostlog", "file", "boot.log", "right" };
